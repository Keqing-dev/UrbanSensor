...
public class ProjectController {
    ...
    public ResponseEntity<ProjectResponse> createProject(@RequestBody Project project, HttpServletRequest request) throws CustomException {
    ...
    public ResponseEntity<MessageResponse> deleteProject(@RequestParam String projectId, HttpServletRequest request) throws CustomException {
    ...
    public ResponseEntity<ProjectResponse> getMyAllProject(HttpServletRequest request,
        ...
        return ResponseEntity.ok(new ProjectResponse(true, projectList.getContent(), paginated));
    }
    ...
    public ResponseEntity<ProjectResponse> getAllProjectByUser(@RequestParam String userId,
                                                               @RequestParam int page,
    ...
    public ResponseEntity<ProjectResponse> getLatest(HttpServletRequest request) throws CustomException {
        ...
        return ResponseEntity.ok(new ProjectResponse(true, projectList.getContent()));
    }

    @GetMapping(value = "/search")
    @Operation(summary = "Buscar proyecto", security = @SecurityRequirement(name = "bearer"))
    public ResponseEntity<ProjectResponse> searchProjectByUser(@RequestParam String search, @RequestParam int page, HttpServletRequest request) throws CustomException {
        ...
        return ResponseEntity.ok(new ProjectResponse(true, userProjects.getContent(), paginated));
    }
